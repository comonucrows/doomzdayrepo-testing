...
class Movies:
	...
	def fetch_list(self):
		...
		try:
			...
			if page_no == 1 and not self.is_external: kodi_utils.set_property('fenlightfork.exit_params', kodi_utils.folder_path())
	...
	def build_movie_content(self, _position, _id):
		try:
			...
			set_properties({
				...
				'fenlightfork.extras_params': extras_params,
				'fenlightfork.options_params': options_params,
				'fenlightfork.playback_options_params': playback_options_params,
				'fenlightfork.browse_movie_set_params': browse_movie_set_params,
				'fenlightfork.browse_recommended_params': browse_recommended_params,
				'fenlightfork.browse_related_params': browse_related_params,
				'fenlightfork.browse_more_like_this_params': browse_more_like_this_params,
				'fenlightfork.browse_similar_params': browse_similar_params,
				'fenlightfork.browse_in_trakt_list_params': browse_in_trakt_list_params,
				'fenlightfork.trakt_manager_params': trakt_manager_params,
				'fenlightfork.personal_manager_params': personal_manager_params,
				'fenlightfork.tmdb_manager_params': tmdb_manager_params,
				'fenlightfork.favorites_manager_params': favorites_manager_params
				})
