...
class SettingsCache:
	def get(self, setting_id):
		try:
			...
			setting_id = setting_id.replace('fenlightfork.', '')
	...
	def set_memory_cache(self, setting_id, setting_value):
		kodi_utils.set_property('fenlightfork.%s' % setting_id, setting_value)

	def delete_memory_cache(self, setting_id):
		clear_property('fenlightfork.%s' % setting_id)
...
def set_boolean(params):
	...
	set_setting(setting, boolean_dict[get_setting('fenlightfork.%s' % setting)])

def set_string(params):
	current_value = get_setting('fenlightfork.%s' % params['setting_id'])
...
def set_path(params):
	...
	new_value = kodi_utils.kodi_dialog().browse(browse_mode, '', '', defaultt=get_setting('fenlightfork.%s' % setting_id))
	set_setting(setting_id, new_value)
...
def set_source_folder_path(params):
	setting_id = params['setting_id']
	current_setting = get_setting('fenlightfork.%s' % setting_id)
...
def default_setting_values(setting_id):
	if 'fenlightfork.' in setting_id: setting_id = setting_id.replace('fenlightfork.', '')
	d_settings = default_settings()
...
#===============================================================================#
#==================== General
{'setting_id': 'auto_start_fenlightfork', 'setting_type': 'boolean', 'setting_default': 'false'},
{'setting_id': 'addon_icon_choice', 'setting_type': 'string', 'setting_default': 'resources/media/icon.png'},
...
#==================== Downloads
{'setting_id': 'movie_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.astraea/Movies Downloads/', 'browse_mode': '0'},
{'setting_id': 'tvshow_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.astraea/TV Show Downloads/', 'browse_mode': '0'},
{'setting_id': 'premium_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.astraea/Premium Downloads/', 'browse_mode': '0'},
{'setting_id': 'image_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.astraea/Image Downloads/', 'browse_mode': '0'},
...
{'setting_id': 'trakt.client', 'setting_type': 'string', 'setting_default': '2dc6f1180d00b3ae9ed3d853b41af40ab3c26af23f730f50e0a262f277c2780c'},
{'setting_id': 'trakt.secret', 'setting_type': 'string', 'setting_default': 'dca4571439aef5da45b7b03db43b792464069694cf0a35b19bde453de70981be'},
#==================== TMDb API
{'setting_id': 'tmdb_api', 'setting_type': 'string', 'setting_default': 'e7d229e4725ffe65f9458953c3287235'},
#==================== TMDb Lists
{'setting_id': 'tmdb.token', 'setting_type': 'string', 'setting_default': 'empty_setting'},
{'setting_id': 'tmdb.read_access_token', 'setting_type': 'string', 'setting_default': 'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJlN2QyMjllNDcyNWZmZTY1Zjk0NTg5NTNjMzI4NzIzNSIsIm5iZiI6MTQ1MDY0ODM4NS41MzksInN1YiI6IjU2NzcyMzQxOTI1MTQxNzlkYjAwNmEzMSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.FWTeOhPZn5Xqc9DSHaTWbSLZK8nTlJfhtdaMqAZy1NM'},
